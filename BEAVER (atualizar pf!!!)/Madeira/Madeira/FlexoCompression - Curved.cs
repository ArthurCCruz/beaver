...
namespace Madeira
{
    public class FlexoCompressionC : GH_Component
    {
        ...
        public FlexoCompressionC()
          : base("Flexo-Compressão - Arco", "Flex-ComprC",
             "Verificação de perfil curvo solicitado à flexo-compressão pelo Eurocode 5",
              "Madeira", "Verificação")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Curvatura do arco", "rin", "Curvatura máxima do arco", GH_ParamAccess.item, 0);
            pManager.AddNumberParameter("Lamela", "t", "Espessura da lamela",GH_ParamAccess.item,3);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.arco;
            }
        }
