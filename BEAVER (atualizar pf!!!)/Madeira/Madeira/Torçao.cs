...
namespace Madeira
{
    public class Torção : GH_Component
    {
        ...
        public Torção()
          : base("Resistência à Torção", "Torção",
              "Verificação de perfil solicitado à momento torçor pelo Eurocode 5",
              "Madeira", "Verificação")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Momento Torçor", "Mt", "Momento torçor solicitante", GH_ParamAccess.item, 0);
