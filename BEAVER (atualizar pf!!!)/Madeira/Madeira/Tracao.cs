...
namespace Madeira
{
    public class Tension : GH_Component
    {
        ...
        {
            pManager.Register_DoubleParam("Sigtd/ftd", "DIV", "Razão entre a tensão de tração solicitante e" +
                " a resistência do material à tração paralela à fibra");
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.tracao;
            }
        }
